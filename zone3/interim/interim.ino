...
void sendData()
{
    ...
    Serial.write(((int)countCross)&255); // 12/19乾追記
    ...
    int dir = map(direction_G,0,360,0,255);
    Serial.write(((int)dir)&255);
    int dip = map(avex,-12000,12000,0,255);
    Serial.write(((int)dip)&255);
